    ...
    render() {
        return (
            <div className="body-file-user">
                {
                    this.state.focus ? <FileUser setValue={this.setValue} personalData={this.state.presentation} extraData={this.state.dates} changeView={this.changeView} focus={this.state.focus} /> : <Card presentation={this.state.presentation} dates={this.state.dates} focus={this.state.focus} changeView={this.changeView} />
                }
